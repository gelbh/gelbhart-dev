...
export class AnimationManager {
  ...
  animatePacmanMouth(deltaTime) {
    ...
    if (this.controller.animationTimer >= animationInterval) {
      ...
      this.controller.pacmanAnimationState =
        (this.controller.pacmanAnimationState + 1) % 3;
      const sprite = this.pacmanTarget.querySelector(".pacman-sprite");
      if (sprite) {
        sprite.src = this.spriteManager.getPacmanSprite(
          this.controller.pacmanAnimationState
        );
      }
    }
  ...
  smoothScrollTo(targetY, duration) {
    return new Promise((resolve) => {
      ...
      const scroll = () => {
        ...
        const eased = eases.cubicInOut(progress);
  ...
  resetPositions() {
    ...
    this.controller.pacmanPosition = {
      ...this.controller.initialPacmanPosition,
    };
