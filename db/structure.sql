...
-- CREATE FUNCTION extensions.grant_pg_cron_access() RETURNS event_trigger -- Supabase-managed function, commented out
--     LANGUAGE plpgsql
--     AS $$
-- BEGIN
--   IF EXISTS (
...
--   END IF;
-- END;
-- $$; -- Supabase-managed function, commented out
...
-- COMMENT ON FUNCTION extensions.grant_pg_cron_access() IS 'Grants access to pg_cron'; -- Supabase-managed function
...
-- CREATE FUNCTION extensions.grant_pg_graphql_access() RETURNS event_trigger -- Supabase-managed function, commented out
--     LANGUAGE plpgsql
--     AS $_$
-- DECLARE
...
-- COMMENT ON FUNCTION extensions.grant_pg_graphql_access() IS 'Grants access to pg_graphql'; -- Supabase-managed function
...
-- CREATE FUNCTION extensions.grant_pg_net_access() RETURNS event_trigger -- Supabase-managed function, commented out
--     LANGUAGE plpgsql
--     AS $$
-- BEGIN
--   IF EXISTS (
...
-- COMMENT ON FUNCTION extensions.grant_pg_net_access() IS 'Grants access to pg_net'; -- Supabase-managed function
...
-- CREATE FUNCTION extensions.pgrst_ddl_watch() RETURNS event_trigger -- Supabase-managed function, commented out
--     LANGUAGE plpgsql
--     AS $$
-- DECLARE
--   cmd record;
...
--     END IF;
--   END LOOP;
-- END; $$; -- Supabase-managed function, commented out
...
-- CREATE FUNCTION extensions.pgrst_drop_watch() RETURNS event_trigger -- Supabase-managed function, commented out
--     LANGUAGE plpgsql
--     AS $$
-- DECLARE
--   obj record;
...
CREATE OR REPLACE FUNCTION () RETURNS event_trigger
    LANGUAGE plpgsql
    AS $_$
    DECLARE
